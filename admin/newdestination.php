        ...
        <div class="ml-64 p-6 w-[84%] mx-auto">
            <div class="bg-white shadow-md rounded-lg p-6">
                <div class="bg-gray-100 p-4 rounded-lg mb-6">
                    ...
                    <form action="insertdestination.php" method="POST" enctype="multipart/form-data">
                        <!-- Activity Name -->
                        <div class="mt-8">
                        ...
                        <div class="mb-4 pt-4">
                            <label for="dest_desc" class="block text-sm font-medium text-gray-700 mb-1">Destination Description</label>
