...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($_FILES['des_image']) && $_FILES['des_image']['error'] === UPLOAD_ERR_OK) {
        ...
        if (in_array($img_ext, $allowed_ext) && $img_size <= 2 * 1024 * 1024) {
            $new_img_name = uniqid("destinations_", true) . '.' . $img_ext;
            ...
            if (move_uploaded_file($img_tmp, $upload_path)) {
                $sql = "INSERT INTO destinations (des_name, des_description, des_image, status) 
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
        ...
        <div class="ml-64 p-6 w-full">
            <div class="bg-white shadow-md rounded-lg p-6">
             <h1 class="text-2xl font-bold text-gray-800 mt-12">Add New destinations</h1>
        
                    <form method="POST" enctype="multipart/form-data">
                        <!-- destinations Name -->
                        <div class="mt-8">
                            <label for="des_name" class="block text-sm font-medium text-gray-700 mb-1">Destinations Name</label>
                        ...
                        <div class="mb-4">
                            <label for="des_desc" class="block text-sm font-medium text-gray-700 mb-1">Destinations Description</label>
                        ...
                        <!-- destinations Image -->
                        <div class="mb-4">
                            <label for="des_image" class="block text-sm font-medium text-gray-700 mb-1">Destinations Image</label>
